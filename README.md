...
A native macOS app that gives GUI access to command-line **image and photo**
tools (osxphotos, ImageMagick, and future candidates like ffmpeg/exiftool)
without requiring users to memorize flags or touch Terminal. Scope is
deliberately image/photo-specific, not a general-purpose CLI wrapper — see
